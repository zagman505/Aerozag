package
{
    ...
    public class LoginScreen extends PanelScreen
    {
        ...
        private function loginButton_triggeredHandler(event:Event):void
        {
            ...
            req.onSuccess += function(v:String) { 
                ...
                {
                    // success
                    HTTPExample.loginMessage = "Response Code: " + json.getString("response");
                    HTTPExample.navigator.showScreen("success");

                }
                else
                {
                    //error
                    HTTPExample.loginMessage = json.getObject("meta").getString("message");
                    HTTPExample.navigator.showScreen("failure");
                }
    ...
    public class FailureScreen extends PanelScreen
    {
        ...
        protected function initializeHandler(event:Event):void
        {
            ...
            _message = new Label();
            _message.text = HTTPExample.loginMessage;
            addChild(_message);
